...
function ReviewForm({ bookId }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addReview"])({
                bookId,
                userId: user.id,
                rating,
                reviewText
            ...
            setRating(0);
            setReviewText("");
            // In a real app you'd likely revalidate the path or refetch data
            router.refresh();
        } catch (error) {
            toast({
                variant: "destructive",
...
//# sourceMappingURL=src_c479ce3e._.js.map
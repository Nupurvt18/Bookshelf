...
function ReviewForm({ bookId }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addReview"])({
                bookId,
                userId: user.id,
                rating,
                reviewText
...
_s(ReviewForm, "iFwIRG7z0p1ioekH3AaF964fj6g=", false, function() {
    return [
...
//# sourceMappingURL=src_6eef5acc._.js.map
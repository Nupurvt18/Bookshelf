...
function AuthProvider({ children }) {
    ...
    const login = async (email, name)=>{
        ...
        if (foundUser) {
            ...
            const newUser = {
                id: String(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["users"].length + 1),
...
//# sourceMappingURL=src_3e6dc05d._.js.map